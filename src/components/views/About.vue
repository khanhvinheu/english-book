        ...
        <div style=" width: 100%;">
            <div style="display: flex; background-color: #efefef;">
                ...
                <div style="display: flex;flex-wrap: wrap; flex-direction: column;">
                    ...
                    <a @click="reply(data)" style="color:blue"><ion-icon name="repeat-outline"></ion-icon>
                ...
                <div v-if="data.id== inputActive " style="background-color: #efefef;;display: flex; width: 100%; justify-content: end; padding:2px; margin-top: 2px;">
                ...
                <!-- <button @click="send(data,input[data.id])">Send</button> -->
                    <el-button @click="send(data,input[data.id])"  type="success" size="small"><ion-icon name="send-outline"></ion-icon> Gửi</el-button>
                 </div>
        </div>
